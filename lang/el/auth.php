...
return [
    ...
    */
    ...
    'pending_approval' => [
        'page_title' => 'Αναμονή έγκρισης',
        'title' => 'Ο λογαριασμός σας αναμένει έγκριση',
        'description' => 'Οι νέοι λογαριασμοί πρέπει να εγκριθούν από διαχειριστή πριν χρησιμοποιηθούν. Θα λάβετε email μόλις εγκριθεί ο λογαριασμός σας.',
        'log_out' => 'Αποσύνδεση',
    ],
