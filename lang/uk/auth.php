...
return [
    ...
    */
    ...
    'pending_approval' => [
        'page_title' => 'Очікує підтвердження',
        'title' => 'Акаунт очікує підтвердження',
        'description' => 'Нові акаунти активує адміністратор. Щойно ваш акаунт схвалять, ви отримаєте листа.',
        'log_out' => 'Вийти',
    ],
